...
import { StyledCard, StyledAvatar, StyledCardContent, StyledListItemText } from '../PublicFavors/styled-components';
import { StyledCardHeader, StyledCardActions } from '../../../utils/styled-components';
...
export default props => {
  ...
  const paginatedFavors = favors.slice(((currentPage - 1) * PER_PAGE), ((currentPage) * PER_PAGE))
              ...
              <Fragment key={favor.id}>
                <ListItem alignItems="flex-start">
                  <ListItemAvatar>
                    ...
                    >
                      {`${favor.user.firstName.substring(0, 1)}${favor.user.lastName.substring(0, 1)}`}
                    </StyledAvatar>
                  </ListItemAvatar>
                  <StyledListItemText
                    primary={favor.title}
