...
router.patch('/update-settings', verifyAuth, userValidator.updateSettings, userController.updateSettings);
router.patch('/upload-picture', verifyAuth, uploaders.profilePictureUploader, userController.uploadPicture);
