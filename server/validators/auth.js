...
module.exports.signup = [
  ...
  body('password')
    .not().isEmpty().withMessage('Password is invalid')
    .isLength({ min: 6 }).withMessage('Password is invalid'),
  body('passwordConfirm')
    .not().isEmpty().withMessage('Confirmation password is invalid')
    .isLength({ min: 6 }).withMessage('Confirmation password must be at least 6 characters')
